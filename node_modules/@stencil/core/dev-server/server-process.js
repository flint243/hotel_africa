/*!
 Stencil Dev Server Process v4.15.0 | MIT Licensed | https://stenciljs.com
 */
'use strict';
...
const fs$6 = require('node:fs/promises');
...
const fs$7 = require('../sys/node/graceful-fs.js');
...
const process__default = /*#__PURE__*/_interopDefaultLegacy(process$3);
const path__default$1 = /*#__PURE__*/_interopDefaultLegacy(path$5);
const url__default = /*#__PURE__*/_interopDefaultLegacy(url);
const childProcess__default = /*#__PURE__*/_interopDefaultLegacy(childProcess$1);
const fs__default$1 = /*#__PURE__*/_interopDefaultLegacy(fs$6);
const fs__default = /*#__PURE__*/_interopDefaultLegacy(fs$5);
...
const os__default = /*#__PURE__*/_interopDefaultLegacy(os$3);
const fs__default$2 = /*#__PURE__*/_interopDefaultLegacy(fs$7);
...
const untildify$1 = untildify;

const macOsVersion = Number(require$$0__default$1['default'].release().split('.')[0]);
...
async function defaultBrowserId() {
	...
	let buffer;
	try {
		buffer = await require$$0.promises.readFile(filePath);
	} catch (error) {
...
const crossSpawn$1 = crossSpawn$2.exports;
...
const pathKey = pathKey$2.exports;
...
action:"terminate",
description:"Invalid system call",
standard:"other"}];core.SIGNALS=SIGNALS$1;
...
const SIGRTMIN$1=34;
const SIGRTMAX$1=64;realtime.SIGRTMAX=SIGRTMAX$1;

Object.defineProperty(signals$4,"__esModule",{value:true});signals$4.getSignals=void 0;var _os$1=require$$0__default$1['default'];
...
Object.defineProperty(main,"__esModule",{value:true});main.signalsByNumber=main.signalsByName=void 0;var _os=require$$0__default$1['default'];
...
const getSignalByName$1=function(
signalByNameMemo,
...
const signalsByName$2=getSignalsByName$1();main.signalsByName=signalsByName$2;
...
getSignalByNumber$1(number,signals));
...
const signalsByNumber=getSignalsByNumber$1();main.signalsByNumber=signalsByNumber;
...
const onExit$1 = signalExit$1.exports;
...
const isStream$2 = stream =>
	stream !== null &&
	typeof stream === 'object' &&
	typeof stream.pipe === 'function';

isStream$2.writable = stream =>
	isStream$2(stream) &&
	stream.writable !== false &&
	typeof stream._write === 'function' &&
	typeof stream._writableState === 'object';

isStream$2.readable = stream =>
	isStream$2(stream) &&
	stream.readable !== false &&
	typeof stream._read === 'function' &&
	typeof stream._readableState === 'object';

isStream$2.duplex = stream =>
	isStream$2.writable(stream) &&
	isStream$2.readable(stream);

isStream$2.transform = stream =>
	isStream$2.duplex(stream) &&
...
const {PassThrough: PassThroughStream$1} = require$$0__default$4['default'];
...
const {constants: BufferConstants$1} = require$$0__default$5['default'];
const stream$2 = require$$0__default$4['default'];
...
getStream$5.exports.buffer = (stream, options) => getStream$4(stream, {...options, encoding: 'buffer'});
getStream$5.exports.array = (stream, options) => getStream$4(stream, {...options, array: true});
...
const mergeStream$2 = mergeStream$1;

const isStream$1 = isStream_1;
const getStream$3 = getStream$5.exports;
...
const getStreamPromise$1 = (stream, {encoding, buffer, maxBuffer}) => {
	...
	if (encoding) {
		return getStream$3(stream, {encoding, maxBuffer});
	}

	return getStream$3.buffer(stream, {maxBuffer});
};
...
const crossSpawn = crossSpawn$2.exports;
const stripFinalNewline$1 = stripFinalNewline$2;
const npmRunPath$1 = npmRunPath$2.exports;
const onetime$2 = onetime$4.exports;
const makeError$1 = error;
const normalizeStdio$1 = stdio.exports;
...
const execa$1 = (file, args, options) => {
	...
	const handlePromiseOnce = onetime$2(handlePromise);
...
const pipeToTarget = (spawned, streamName, target) => {
	if (typeof target === 'string') {
		spawned[streamName].pipe(fs$5.createWriteStream(target));
		return spawned;
	}
...
const getStream$1 = getStream$2.exports;
...
const getInput = ({input, inputFile}) => {
	...
	return fs$5.createReadStream(inputFile);
};
...
const getWslDrivesMountPoint = (() => {
	...
	return async function () {
		...
		try {
			await fs__default$1['default'].access(configFilePath, fs$5.constants.F_OK);
		...
		const configContent = await fs__default$1['default'].readFile(configFilePath, {encoding: 'utf8'});
...
const baseOpen = async options => {
	...
	if (platform === 'darwin') {
		...
		if (app) {
			...
			try {
				await fs__default$1['default'].access(localXdgOpenPath, fs$5.constants.X_OK);
...
function createServerContext(sys, sendMsg, devServerConfig, buildResultsResolves, compilerRequestResolves) {
    ...
    const serve500 = (req, res, error, xSource) => {
        try {
            ...
            res.write(require$$2__default$1['default'].inspect(error));
            res.end();
            logRequest(req, 500);
        }
        catch (e) {
    ...
    const serve404 = (req, res, xSource, content = null) => {
        try {
            if (req.pathname === '/favicon.ico') {
                ...
                const rs = fs__default$2['default'].createReadStream(defaultFavicon);
                rs.on('error', (err) => {
                    res.writeHead(404, responseHeaders({
                        'content-type': 'text/plain; charset=utf-8',
                        'x-source': `createReadStream error: ${err}, ${xSource}`,
                    }));
                    res.write(require$$2__default$1['default'].inspect(err));
                    res.end();
                });
                rs.pipe(res);
                return;
    ...
    try {
        if (isSimpleText(req.filePath)) {
            ...
            if (shouldCompress(devServerConfig, req)) {
                ...
                res.writeHead(200, responseHeaders({
                    'content-type': getContentType(req.filePath) + '; charset=utf-8',
                    'content-length': require$$0$5.Buffer.byteLength(content, 'utf8'),
                }));
                res.write(content);
                res.end();
            }
            ...
            fs__default$2['default'].createReadStream(req.filePath).pipe(res);
        }
...
function createWebSocket(httpServer, onMessageFromClient) {
    ...
    const wsServer = new ws__default['default'].Server(wsConfig);
    function heartbeat() {
